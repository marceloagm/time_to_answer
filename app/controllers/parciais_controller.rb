class ParciaisController < ApplicationController
    ...
    def index
        ...
        @apostas = Apostum.all.where(rodada: 2)
        
        @equipes_encontrar = Array.new
        
        @rodada = SalvarRodadaMercado.all

        @equipes_encontrar = SalvarAtletumAnterior.all.where(rodada: 2)
        ...
        while b < @apostas.length 
            ...
            @nome_time_slug[b] = @equipes_encontrar[a]["equipe_nome"]
            @pontos_time_slug[b] = @equipes_encontrar[a]["pontos"]
            @time_slug[b] = @equipes_encontrar[a]["slug"]
